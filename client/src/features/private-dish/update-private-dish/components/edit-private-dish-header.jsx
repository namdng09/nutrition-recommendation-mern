...
function MiniStat({ icon, label, value }) {
  return (
    <div className='rounded-[22px] border border-border bg-card px-4 py-4 text-card-foreground shadow-sm'>
...
export default function EditPrivateDishHeader({
  ingredientCount,
  stepCount,
  servings
}) {
  return (
    <section className='relative overflow-hidden rounded-[36px] border border-border bg-card shadow-[0_18px_48px_rgba(15,23,42,0.07)]'>
      <div className='absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(16,185,129,0.10),transparent_24%),radial-gradient(circle_at_bottom_left,rgba(59,130,246,0.08),transparent_20%)]' />
