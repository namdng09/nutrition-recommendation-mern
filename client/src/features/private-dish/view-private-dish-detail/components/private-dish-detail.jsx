  ...
  return (
    <div className='mx-auto w-full max-w-7xl animate-in space-y-16 px-4 pb-6 fade-in slide-in-from-bottom-4 duration-700 sm:px-6 lg:px-0'>
      <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
        <button
          onClick={() => navigate(-1)}
          className='group inline-flex items-center gap-3 self-start rounded-full bg-muted/50 px-3 py-2 text-xs font-extrabold tracking-[0.18em] text-muted-foreground transition-all hover:bg-primary/10 hover:text-primary'
        >
        ...
        <div className='flex flex-wrap items-center justify-end gap-3'>
          ...
          <div className='flex flex-wrap items-center gap-2'>
            ...
            <button
              ...
              className='inline-flex items-center gap-2 rounded-full bg-red-500 px-4 py-2.5 text-sm font-bold text-white shadow-md transition hover:bg-red-600 disabled:cursor-not-allowed disabled:opacity-60'
            >
          ...
          {dish.user && (
            <div className='flex items-center gap-4 rounded-[1.5rem] bg-card p-4 shadow-sm ring-1 ring-border/50'>
              ...
              <div>
                ...
                <div className='font-bold'>{dish.user.name}</div>
              </div>
            </div>
          )}
        </div>
