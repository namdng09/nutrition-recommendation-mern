...
export default function DishFavoriteButton({ dishId }) {
  ...
  return (
    <Button
      ...
      variant='ghost'
      disabled={isLoading}
      className='absolute right-4 top-4 z-20 rounded-full border border-border bg-white/80 backdrop-blur transition hover:bg-pink-50'
    >
      <Heart
        size={18}
